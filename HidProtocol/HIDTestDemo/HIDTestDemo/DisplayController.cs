...
namespace HID.DisplayController
{
    ...
    public class DisplayController
    {
        ...
        public DeviceFWInfo? GetDeviceInfo()
        {
        ...
        public async Task<bool> SimpleRealTimeDisplayDemo(string? imageDirectory = null, int cycleCount = 5)
        {
            ...
            try
            {
                ...
                var enableResponse = await SendCmdRealTimeDisplayWithResponse(true, sequenceNumber: 40);
                ...
                await SendCmdBrightnessWithResponse(80, sequenceNumber: 43);
                // Set optimal settings
                //await SendCmdSetKeepAliveTimerWithResponse(60, sequenceNumber: 23);
                ...
                if (imagePaths.Count > 0)
                {
                    ...
                    for (int cycle = 0; cycle < cycleCount; cycle++)
                    {
                        foreach (var imagePath in imagePaths)
                        {
                            ...
                            SendCmdKeepAlive(DateTimeOffset.UtcNow.ToUnixTimeSeconds(), sequenceNumber: 40 + cycle);
                ...
                await SendCmdRealTimeDisplayWithResponse(false, sequenceNumber: 20);
