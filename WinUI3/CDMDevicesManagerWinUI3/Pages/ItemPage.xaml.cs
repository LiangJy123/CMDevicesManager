...
using CDMDevicesManagerWinUI3.Controls;
...
public sealed partial class ItemPage : Page
{
    ...
    private static string GalleryBaseUrl = "https://github.com/microsoft/WinUI-Gallery/tree/main/CDMDevicesManagerWinUI3/Samples/ControlPages/";
    ...
    protected override async void OnNavigatedTo(NavigationEventArgs e)
    {
        if (e.Parameter is string uniqueId)
        {
            ...
            if (item != null)
            {
                ...
                Type pageType = Type.GetType("CDMDevicesManagerWinUI3.ControlPages." + item.UniqueId + "Page");
